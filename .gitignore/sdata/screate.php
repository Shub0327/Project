                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group">
                            <label>Subject</label>
                            <input type="text" name="name" class="form-control <?php echo (!empty($sub_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $sub; ?>">
                            <span class="invalid-feedback"><?php echo $sub_err;?></span>
                        </div>
                        <div class="form-group">
                            <label>Notice</label>
                            <textarea name="post" class="form-control <?php echo (!empty($note_err)) ? 'is-invalid' : ''; ?>"><?php echo $note; ?></textarea>
